...
import static com.cedaniel200.automation.screenplay.sop.Actors.theActorCalled;
...
public class CreateRepositoryInGitHubStepDefinition {
    ...
    public void shouldSeeTheRepositorioCreated() {
        theActorInTheSpotlight().shouldSeeThat(new Question() {
            @Override
            public boolean answer(WebDriver driver) {
                return driver.getCurrentUrl().equals(BASE_URL_OF_REPOSITORY_CREATED);
            }
